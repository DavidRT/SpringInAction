...
public class SpittleControllerTest {
	...
	public void shouldShowRecentSpittles() throws Exception{
		...
		// mock implementation of repo interface
	...
	public void testSpittle() throws Exception{
		...
		mockMvc.perform(get("/spittles/12345")).andExpect(view()
				.name("spittle"))
	...
	public void saveSpittle() throws Exception{
	    ...
	    verify(mockRepository, atLeastOnce()).save(new Spittle( "Hello World", new Date(), -81.5811668, 28.4159649));
	}
